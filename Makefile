...
ifneq ($(filter $(BOARD),PCA10031 ARS100748 NRF51_BOARD),)
  PLATFORM ?= NRF51
else ifneq ($(filter $(BOARD),PCA10036 PCA10040 NRF52_BOARD),)
  PLATFORM ?= NRF52
endif

#Build directories
BASE_DIRECTORY ?= _build
PLATFORM_DIRECTORY ?= $(BASE_DIRECTORY)/$(BUILD_TYPE)/$(BOARD)
